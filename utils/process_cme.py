...
def gen_train_data(dataset, split, time_step, nb_nodes, nhood, global_att, batch_size, reverse, PG_type):
	...
	return X_train_J, X_train_P, X_train_B, X_train_In, y_train, X_test_J, X_test_P, X_test_B, X_test_In, y_test, \
	       adj_joint, biases_joint, adj_part, biases_part, adj_body, biases_body, adj_interp, biases_interp, nb_classes
